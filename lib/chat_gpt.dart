...
class ChatGPTScreen extends StatefulWidget {
  const ChatGPTScreen({Key? key,required this.apiKey}) : super(key: key);
final String apiKey;
  @override
...
class _ChatGPTScreenState extends State<ChatGPTScreen> {
  ...
  void initState() {
    ...
    /// INSERT API KEY ///
    //
    openAI = OpenAI.instance.build(token:  widget.apiKey, baseOption: HttpSetup(receiveTimeout: Duration(seconds: 16)));
  ...
  getChatGPTData({required String question}) {
    var request = CompleteText(prompt: question, model: Model.textDavinci3, maxTokens: 200);
